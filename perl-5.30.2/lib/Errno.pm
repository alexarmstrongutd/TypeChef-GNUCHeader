...
"i686-linux-4.15.0-99-generic" or
	die "Errno architecture (i686-linux-4.15.0-99-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
